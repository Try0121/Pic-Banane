const CACHE="pic-banane-v8";
const CORE=[
"./","./index.html","./manifest.webmanifest",
"./assets/jungle-bg.jpg","./assets/banana.png",
"./assets/monkey-stage-1.png","./assets/monkey-stage-2.png","./assets/monkey-stage-3.png","./assets/monkey-stage-4.png","./assets/monkey-stage-5.png",
